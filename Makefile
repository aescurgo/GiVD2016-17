...
# Project:  ../Practica1/RayTracingEst.pro
# Template: app
# Command: /opt/Qt5.7.0/5.7/gcc_64/bin/qmake -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ../Practica1/RayTracingEst.pro
#############################################################################
...
INCPATH       = -I../Practica1 -I. -I/opt/X11/include -I/opt/Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = RayTracingEst1.0.0
DISTDIR = /home/alvaro/Escritorio/Grafics/build-RayTracingEst-Desktop_Qt_5_7_0_GCC_64bit-Debug/.tmp/RayTracingEst1.0.0
LINK          = g++
LFLAGS        = 
...
SOURCES       = ../Practica1/RayTracing.cpp \
		../Practica1/Scene.cpp \
		../Practica1/Object.cpp \
		../Practica1/Camera.cpp \
		../Practica1/Hitable.cpp \
		../Practica1/Material.cpp \
		../Practica1/Sphere.cpp \
		../Practica1/Lambertian.cpp \
		../Practica1/BoundaryObject.cpp \
		../Practica1/ReadFile.cpp \
		../Practica1/Cara.cpp \
		../Practica1/plane.cpp 
...
DIST          = /opt/Qt5.7.0/5.7/gcc_64/mkspecs/features/spec_pre.prf \
		...
		../Practica1/RayTracingEst.pro Object.h \
		Ray.h \
		Scene.h \
		Camera.h \
		Hitable.h \
		...
		ReadFile.h \
		Cara.h \
		plane.h ../Practica1/RayTracing.cpp \
		../Practica1/Scene.cpp \
		../Practica1/Object.cpp \
		../Practica1/Camera.cpp \
		../Practica1/Hitable.cpp \
...
Makefile: ../Practica1/RayTracingEst.pro /opt/Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++/qmake.conf /opt/Qt5.7.0/5.7/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/Qt5.7.0/5.7/gcc_64/mkspecs/common/unix.conf \
		/opt/Qt5.7.0/5.7/gcc_64/mkspecs/common/linux.conf \
		/opt/Qt5.7.0/5.7/gcc_64/mkspecs/common/sanitize.conf \
		/opt/Qt5.7.0/5.7/gcc_64/mkspecs/common/gcc-base.conf \
		...
		/opt/Qt5.7.0/5.7/gcc_64/mkspecs/features/yacc.prf \
		/opt/Qt5.7.0/5.7/gcc_64/mkspecs/features/lex.prf \
		../Practica1/RayTracingEst.pro
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ../Practica1/RayTracingEst.pro
...
RayTracing.o: ../Practica1/RayTracing.cpp ../Practica1/RayTracing.h \
		../Practica1/Scene.h \
		../Practica1/Ray.h \
		../Practica1/Hitable.h \
		../Practica1/Object.h \
		../Practica1/Material.h \
		../Practica1/Lambertian.h \
		../Practica1/Sphere.h \
		../Practica1/BoundaryObject.h \
		../Practica1/Cara.h \
		../Practica1/ReadFile.h \
		../Practica1/Camera.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o RayTracing.o ../Practica1/RayTracing.cpp

Scene.o: ../Practica1/Scene.cpp ../Practica1/Scene.h \
		../Practica1/Ray.h \
		../Practica1/Hitable.h \
		../Practica1/Object.h \
		../Practica1/Material.h \
		...
		../Practica1/ReadFile.h \
		../Practica1/Camera.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Scene.o ../Practica1/Scene.cpp

Object.o: ../Practica1/Object.cpp ../Practica1/Object.h \
		../Practica1/Ray.h \
		../Practica1/Hitable.h \
		../Practica1/Material.h \
		../Practica1/Lambertian.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Object.o ../Practica1/Object.cpp

Camera.o: ../Practica1/Camera.cpp ../Practica1/Camera.h \
		../Practica1/Ray.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Camera.o ../Practica1/Camera.cpp

Hitable.o: ../Practica1/Hitable.cpp ../Practica1/Hitable.h \
		../Practica1/Ray.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Hitable.o ../Practica1/Hitable.cpp

Material.o: ../Practica1/Material.cpp ../Practica1/Material.h \
		../Practica1/Ray.h \
		../Practica1/Hitable.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Material.o ../Practica1/Material.cpp

Sphere.o: ../Practica1/Sphere.cpp ../Practica1/Sphere.h \
		../Practica1/Object.h \
		../Practica1/Ray.h \
		../Practica1/Hitable.h \
		../Practica1/Material.h \
		../Practica1/Lambertian.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Sphere.o ../Practica1/Sphere.cpp

Lambertian.o: ../Practica1/Lambertian.cpp ../Practica1/Lambertian.h \
		../Practica1/Material.h \
		../Practica1/Ray.h \
		../Practica1/Hitable.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Lambertian.o ../Practica1/Lambertian.cpp

BoundaryObject.o: ../Practica1/BoundaryObject.cpp ../Practica1/BoundaryObject.h \
		../Practica1/Object.h \
		../Practica1/Ray.h \
		../Practica1/Hitable.h \
		../Practica1/Material.h \
		...
		../Practica1/Cara.h \
		../Practica1/ReadFile.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o BoundaryObject.o ../Practica1/BoundaryObject.cpp

ReadFile.o: ../Practica1/ReadFile.cpp ../Practica1/ReadFile.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ReadFile.o ../Practica1/ReadFile.cpp

Cara.o: ../Practica1/Cara.cpp ../Practica1/Cara.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Cara.o ../Practica1/Cara.cpp

plane.o: ../Practica1/plane.cpp ../Practica1/plane.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o plane.o ../Practica1/plane.cpp

####### Install

install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/RayTracingEst/bin || mkdir -p $(INSTALL_ROOT)/opt/RayTracingEst/bin
